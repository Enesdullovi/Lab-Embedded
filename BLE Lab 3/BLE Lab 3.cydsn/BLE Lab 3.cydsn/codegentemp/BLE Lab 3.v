...
module BLE_v1_10_0 (
	...
	cy_clock_v1_0
		#(.id("58c1caf1-3144-46fc-9c9b-d0497cc92e0a/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
// OpAmp_P4_v1_10(Compensation=3, DeepSleepSupport=false, Mode=1, OutputCurrent=0, Power=3, CY_COMPONENT_NAME=OpAmp_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Opamp, CY_INSTANCE_SHORT_NAME=Opamp, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  3.1 Component Pack 1, INSTANCE_NAME=Opamp, )
...
module ADC_SAR_SEQ_P4_v2_0_2 (
	...
	cy_clock_v1_0
		#(.id("19ce0088-6e44-4339-b283-10331daf4e80/5c71752a-e182-47ca-942c-9cb20adbdf2f"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    assign Net_1292 = 1'h0;

    ADC_SAR_SEQ_P4_v2_0_2 ADC (
        .Vref(Net_1374),
        .sdone(Net_1375),
        .eoc(Net_1376),
        .aclk(1'b0),
	...
	cy_clock_v1_0
		#(.id("38acc32f-4019-4cb9-99d0-d9aea4d86d0c"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("26f3c2d9-1845-4c59-baa0-6c352725468e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
